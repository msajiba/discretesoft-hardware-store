...
const BusinessSummary = () => {
    return (
        <div className='my-24 '>
            <h1 className='text-secondary uppercase md:text-4xl text-2xl text-center'> Millions business trust us  </h1>
            ...
            <div className="md:mx-20 shadow-2xl my-5  py-20">
                <div className='text-center'>
                    <h2 className='uppercase text-secondary md:text-2xl'> have any question about us or get a products request ? </h2>
                    <p className='text-primary mt-2 md:text-1xl'> Don't hesitate to contact us </p>
                </div>
                <div>
                    <div className="flex justify-end mr-20 mt-5">
                        <button className='btn btn-secondary  btn-xs text-primary mx-5'> request for quote </button>
                        <button  className='btn btn-primary btn-xs text-secondary'> Contact Us </button>
                    </div>
                </div>
            </div>
